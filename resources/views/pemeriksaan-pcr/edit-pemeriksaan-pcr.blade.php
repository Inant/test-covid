            ...
            <div class="col-md-12">
                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('pemeriksaan-pcr.update', $dataPemeriksaan->id_pemeriksaan) }}" method="post">
                            @method('PUT')
                            @csrf
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="position-relative form-group col-md-4">
                                    ...
                                    <input name="tgl_swab" id="tgl_swab" placeholder="Tanggal Swab" type="datetime-local" class="form-control @error('tgl_swab') is-invalid @enderror" value="{{ old('tgl_swab', date('Y-m-d\TH:i',strtotime($dataPemeriksaan->tgl_swab))) }}">
                                    @error('tgl_swab')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="position-relative form-group col-md-4">
                                    ...
                                    <input name="tgl_diterima" id="tgl_diterima" placeholder="Tanggal Diterima" type="datetime-local" class="form-control @error('tgl_diterima') is-invalid @enderror" value="{{ old('tgl_diterima', date('Y-m-d\TH:i',strtotime($dataPemeriksaan->tgl_diterima))) }}">
                                    @error('tgl_diterima')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="position-relative form-group col-md-4">
                                    ...
                                    <input name="tgl_validasi" id="tgl_validasi" placeholder="Tanggal Validasi" type="datetime-local" class="form-control @error('tgl_validasi') is-invalid @enderror" value="{{ old('tgl_validasi', date('Y-m-d\TH:i',strtotime($dataPemeriksaan->tgl_validasi))) }}">
                                    @error('tgl_validasi')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="position-relative form-group col-md-4">
                                    ...
                                    <input name="tgl_cetak_hasil" id="tgl_cetak_hasil" placeholder="Tanggal Cetak Hasil" type="datetime-local" class="form-control @error('tgl_cetak_hasil') is-invalid @enderror" value="{{ old('tgl_cetak_hasil', date('Y-m-d\TH:i',strtotime($dataPemeriksaan->tgl_cetak_hasil))) }}">
                                ...
                                <div class="position-relative form-group col-md-8">
                                    ...
                                    <textarea name="keterangan" class="ck-editor" placeholder="keterangan" class="form-control @error('keterangan') is-invalid @enderror">{{ old('keterangan', $dataPemeriksaan->keterangan) }}</textarea>
                                    @error('keterangan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-inline">
                                                        <form action="{{ route('pemeriksaan-pcr.detail.destroy', ['detail'=>$item->id_detail,'id_pemeriksaan'=>$dataPemeriksaan->id_pemeriksaan]) }}" method="post">
                                                            @csrf
                                                            @method('delete')
                    ...
                    <div class="col-md-4">
                        <div class="main-card mb-3 card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('pemeriksaan-pcr.store.detail', [$dataPemeriksaan->id_pemeriksaan]) }}" method="post">
                                    @csrf
                                    <div class="position-relative form-group">
                                        ...
                                        <select name="tipe_pemeriksaan" id="tipe_pemeriksaan" class="form-control @error('pengirim') is-invalid @enderror">
                                            ...
                                            @foreach ($findAllTipe as $item)
                                                <option value="{{ $item->id_tipe }}" {{ old('tipe_pemeriksaan') == $item->id_tipe ? 'selected' : '' }} > {{$item->tipe_pcr}} </option>
                                            @endforeach
                                        </select>
