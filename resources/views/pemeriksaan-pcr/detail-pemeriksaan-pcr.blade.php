                        ...
                        <div class="main-card mb-3 card">
                            <div class="card-body">
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item">
                                        Tanggal Swab: <span class="text-capitalize"> {{date('d-m-Y H:i', strtotime($pemeriksaan->tgl_swab))}} </span>
                                    </li>
                                    <li class="list-group-item">
                                        Tanggal Diterima: <span class="text-capitalize"> {{date('d-m-Y H:i', strtotime($pemeriksaan->tgl_diterima))}} </span>
                                    </li>
                                    <li class="list-group-item">
                                        Tanggal Validasi: <span class="text-capitalize"> {{date('d-m-Y H:i', strtotime($pemeriksaan->tgl_validasi))}} </span>
                                    </li>
                                    <li class="list-group-item">
                                        Tanggal Cetak Hasil: <span class="text-capitalize"> {{date('d-m-Y H:i', strtotime($pemeriksaan->tgl_cetak_hasil))}} </span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="main-card mb-3 card">
                            <div class="card-body">
                                ...
                                <a href="{{ route('pemeriksaan-pcr.print', $pemeriksaan->id_pemeriksaan) }}" target="_blank">
