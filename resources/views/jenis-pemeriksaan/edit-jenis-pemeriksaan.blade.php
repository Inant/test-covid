            ...
            <div class="col-md-12">
                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('jenis-pemeriksaan.update', $jenisPemeriksaan->id_tipe) }}" method="post">
                            @csrf
                            @method('PUT')
                            <div class="position-relative form-group">
                                <label for="tipe" class="">Jenis Pemeriksaan</label>
                                <input name="tipe" id="tipe" placeholder="Jenis Pemeriksaan" type="text" class="form-control @error('tipe') is-invalid @enderror" value="{{old('tipe', $jenisPemeriksaan->tipe)}}">
                                @error('tipe')
                            ...
                            <div class="position-relative form-group">
                                ...
                                <select name="nilai_normal" id="nilai_normal" class="form-control @error('nilai_normal') is-invalid @enderror">
                                  ...
                                  <option value="NON REAKTIF" {{old('nilai_normal', $jenisPemeriksaan->nilai_normal) == 'NON REAKTIF' ? 'selected' : ''}}>NON REAKTIF</option>
