        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="main-card mb-3 card">
                    <div class="card-header">List Jenis Pemeriksaan Pcr
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-inline">
                                                <a href="{{ route('jenis-pemeriksaan-pcr.edit', $item->id_tipe) }}" class="mr-2">
                                                ...
                                                <form action="{{ route('jenis-pemeriksaan-pcr.destroy', $item->id_tipe) }}" method="post">
                                                    @csrf
                                                    @method('delete')
